...
#define CALCULATING_SSL_CERT_HASH_PATH "Client_cache/client_user_existence_checking.calculating_ssl_cert_hash"
	...
	void (*backend_fatal_alert_msg_callback_handler_ptr)(char *alert_msg))
{
	...
	{
		backend_alert_msg_handler_callback("Sending user existence checking information failed");
		goto ERROR;
	}
	...
	{
		backend_alert_msg_handler_callback("Receiving user existence checking result failed");
		goto ERROR;
	}
