...
#define PASSWD_RESETTING_CODE_REQUESTING_INFO_CIPHERTEXT_PATH   "Client_cache/client_passwd_resetting.passwd_resetting_code_requesting_info_ciphertext"
#define PASSWD_RESETTING_CODE_REQUESTING_INFO_PLAINTEXT_PATH    "Client_cache/client_passwd_resetting.passwd_resetting_code_requesting_info_plaintext"
#define PASSWD_RESETTING_CODE_REQUESTING_RESULT_CIPHERTEXT_PATH "Client_cache/client_passwd_resetting.passwd_resetting_code_requesting_result_ciphertext"
#define PASSWD_RESETTING_CODE_REQUESTING_RESULT_PLAINTEXT_PATH  "Client_cache/client_passwd_resetting.passwd_resetting_code_requesting_result_plaintext"

#define PASSWD_RESETTING_INFO_CIPHERTEXT_PATH   		"Client_cache/client_passwd_resetting.passwd_resetting_info_ciphertext"
#define PASSWD_RESETTING_INFO_PLAINTEXT_PATH    		"Client_cache/client_passwd_resetting.passwd_resetting_info_plaintext"
#define PASSWD_RESETTING_RESULT_CIPHERTEXT_PATH 		"Client_cache/client_passwd_resetting.passwd_resetting_result_ciphertext"
#define PASSWD_RESETTING_RESULT_PLAINTEXT_PATH  		"Client_cache/client_passwd_resetting.passwd_resetting_result_plaintext"
...
boolean request_passwd_resetting_code(char *user_auth_ip_addr, char *username, boolean is_admin_flag, void (*backend_alert_msg_callback_handler_ptr)(char *alert_msg))
{
	...
	sprintf(user_auth_addr, "%s:%s", user_auth_ip_addr, UA_USER_PASSWD_RESETTING_PORT);
	...
	// Encrypt the password resetting code requesting information with the User Authority's public key
	if(!smime_encrypt_with_cert(PASSWD_RESETTING_CODE_REQUESTING_INFO_PLAINTEXT_PATH, 
		PASSWD_RESETTING_CODE_REQUESTING_INFO_CIPHERTEXT_PATH, UA_PUB_CERTFILE_PATH, err_msg))
	{
...
boolean reset_passwd(char *user_auth_ip_addr, char *username, boolean is_admin_flag, char *resetting_code, void (*backend_alert_msg_callback_handler_ptr)(char *alert_msg))
{
	...
	// Encrypt the password resetting information with the User Authority's public key
	if(!smime_encrypt_with_cert(PASSWD_RESETTING_INFO_PLAINTEXT_PATH, PASSWD_RESETTING_INFO_CIPHERTEXT_PATH, UA_PUB_CERTFILE_PATH, err_msg))
	{
