...
#define CALCULATING_SSL_CERT_HASH_PATH "Client_cache/client_transaction_logout_log_recording.calculating_ssl_cert_hash"
	...
	void (*backend_fatal_alert_msg_callback_handler_ptr)(char *alert_msg))
{
	...
	// Send a request type
	write_token_into_buffer("request_type", LOGOUT_LOG_RECORDING, true, buffer);
