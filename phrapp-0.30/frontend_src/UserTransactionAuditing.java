...
class UserTransactionAuditing extends JDialog implements ConstantVars
{
	...
	private native void audit_all_transaction_logs_main(boolean audit_login_log_flag);
	private native void audit_some_period_time_transaction_logs_main(boolean audit_login_log_flag, String start_date_time, String end_date_time);
	...
	public UserTransactionAuditing(Component parent, TransactionLogType transaction_log_type, ConfirmSignal confirm_dialg_exiting)
	{
	...
	private final void init_ui(Component parent)
	{
		...
		// Transaction logs
		JLabel transaction_log_label = (transaction_log_type == TransactionLogType.USER_LOGIN_LOG) ? new JLabel("Login Logs") : new JLabel("Event Logs");
	...
	public UserTransactionAuditing(Component parent, TransactionLogType transaction_log_type, int start_year_index, int start_month_index, int start_day_index, 
	...
	{
		if(transaction_log_type == TransactionLogType.USER_LOGIN_LOG)
		{
	...
	private synchronized void add_transaction_login_log_to_table_callback_handler(final String date_time, final String ip_address, final boolean is_logout_flag)
	{
