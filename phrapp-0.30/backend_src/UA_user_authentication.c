...
#define VERIFICATION_INFO_CIPHERTEXT_PATH   "UA_cache/UA_user_authentication.verification_info_ciphertext"
#define VERIFICATION_INFO_PLAINTEXT_PATH    "UA_cache/UA_user_authentication.verification_info_plaintext"
#define VERIFICATION_RESULT_CIPHERTEXT_PATH "UA_cache/UA_user_authentication.verification_result_ciphertext"
#define VERIFICATION_RESULT_PLAINTEXT_PATH  "UA_cache/UA_user_authentication.verification_result_plaintext"

#define SALTED_PASSWD_HASH_PATH      	    "UA_cache/UA_user_authentication.salted_passwd_hash"

#define SSL_CERT_PLAINTEXT_PATH             "UA_cache/UA_user_authentication.ssl_cert_plaintext"
#define SSL_CERT_CIPHERTEXT_PATH            "UA_cache/UA_user_authentication.ssl_cert_ciphertext"

#define SSL_CERT_HASH_PLAINTEXT_PATH        "UA_cache/UA_user_authentication.ssl_cert_hash_plaintext"
#define SSL_CERT_HASH_CIPHERTEXT_PATH       "UA_cache/UA_user_authentication.ssl_cert_hash_ciphertext"
...
static boolean record_transaction_complete_login_log(SSL *ssl_client, char *username, boolean is_admin_flag);
...
static boolean record_transaction_complete_login_log(SSL *ssl_client, char *username, boolean is_admin_flag)
{
	...
	write_token_into_buffer("is_admin_flag", (is_admin_flag) ? "1" : "0", false, buffer);
...
static boolean basic_info_response(SSL *ssl_client, char *username, boolean is_admin_flag)
{
	...
	write_token_into_buffer("audit_server_ip_addr", GLOBAL_audit_server_ip_addr, false, buffer);
	write_token_into_buffer("phr_server_ip_addr", GLOBAL_phr_server_ip_addr, false, buffer);
	write_token_into_buffer("emergency_server_ip_addr", GLOBAL_emergency_server_ip_addr, false, buffer);
